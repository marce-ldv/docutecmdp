export const Footer = () => {
  ...
  //       © 2022{" "}
  //       <a href="https://docutecmdp.com/" className="hover:underline">
  //         Docutecmdp™
  //       </a>
  //       . All Rights Reserved.
  //     </span>
        ...
        <div className="mx-auto max-w-screen-xl text-center">
          <div className="grid lg:grid-cols-3">
            ...
            <form action="#" className="flex w-full max-w-sm lg:ml-auto">
              ...
              <button type="submit"
                      className="py-3 px-5 text-sm text-center text-white rounded-r-lg border cursor-pointer bg-primary-600 border-primary-600 hover:bg-primary-700 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Subscribe
              </button>
            </form>
          </div>
          <hr className="my-6 border-gray-200 sm:mx-auto dark:border-gray-700 lg:my-8" />
            <div className="sm:items-center sm:justify-between sm:flex">
              <span className="block text-sm text-gray-500 dark:text-gray-400">© 2021-2022 <a
